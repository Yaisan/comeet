...
var config = {
    ...
    hosts: {
        // XMPP domain.
        domain: 'meet.yaisan.cat',

        // When using authentication, domain for guest users.
        anonymousdomain: 'guest.meet.yaisan.cat',

        // Domain for authenticated users. Defaults to <domain>.
        // authdomain: 'meet.yaisan.cat',

        // Focus component domain. Defaults to focus.<domain>.
        // focus: 'focus.meet.yaisan.cat',

        // XMPP MUC domain. FIXME: use XEP-0030 to discover it.
        muc: 'conference.<!--# echo var="subdomain" default="" -->meet.yaisan.cat'
    },

    // BOSH URL. FIXME: use XEP-0156 to discover it.
    bosh: '//meet.yaisan.cat/http-bind',

    // Websocket URL
    // websocket: 'wss://meet.yaisan.cat/xmpp-websocket',
    ...
    // focusUserJid: 'focus@auth.meet.yaisan.cat',
    ...
    //     // by default uses:
    //     // 'https://meet.yaisan.cat/static/oauth.html'
    //     redirectURI:
    //          'https://meet.yaisan.cat/subfolder/static/oauth.html'
    // },
    ...
    p2p: {
        ...
        stunServers: [
            ...
            // { urls: 'stun:meet.yaisan.cat:3478' },
    ...
    */
    ...
    // moderatedRoomServiceUrl: 'https://moderated.meet.yaisan.cat',
